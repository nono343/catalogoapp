...
function BerenjenaPackagingTable() {
    const [products, setProducts] = useState([
        {
          Packaging: 'Conical bag with band',
          Presentation: '5',
        ...
        },
        {
          ...
          'Box size': '40*30*8',
          '80x120': '224',
          'Net Weight 80x120 (Kg)': '448',
          '100x120': '280',
          'Net Weight 100x120 (Kg)': '560',
          Image: amela1,
        },
      ]);
  ...
  export default BerenjenaPackagingTable;
