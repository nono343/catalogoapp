...
import CherryPeraDetalle from './pages/detailPages/cherryPeraDetalle';
import CherryRedondoDetalle from './pages/detailPages/cherryRedondoDetalle';
...
function Catalogo() {
  return (
    <Routes>
      ...
      <Route path="cherrys/pera/:nombreCard" element={<CherryPeraDetalle />} />
      <Route path="cherrys/redondo/:nombreCard" element={<CherryRedondoDetalle />} />
